	...
	/// in a widget, would be "options"
		...
		*/
		this.getZoom = function () {
			return timelineMediator.getZoomLevel();
		};
		
		this.setZoom = function (z) {
			n = parseInt(z, 10);
			if (n <=100 && n>0) { timelineMediator.setZoomLevel(n); }
		};
		...
		****************************************
		*/
		function TimegliderTimelineView (mediator, settings) {
	    ...
	    this.load(MAIN_TEMPLATE, {}, function() {
			...
			if (settingsCheck == "") {
				...
				timelineMediator.setFocusDate(tgDate.makeDateObject(settings.initial_focus));

				var timelineView = new TimegliderTimelineView(timelineMediator, settings);
				
				// load timelines
				timelineMediator.loadTimelineData(settings.data_source);
