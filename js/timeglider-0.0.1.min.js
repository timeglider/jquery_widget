...
m.append("<img id='test_img' src='"+u+"'>");u=H("#test_img").width();var z=H("#test_img").height();m.html("");return{width:u,height:z}};f.validateOptions=function(u){this.optionsMaster={initial_focus:{type:"date"},editor:{type:"string"},backgroundColor:{type:"color"},backgroundImage:{type:"color"},min_zoom:{type:"number",min:1,max:100},max_zoom:{type:"number",min:1,max:100},initial_zoom:{type:"number",min:1,max:100},show_centerline:{type:"boolean"},display_zoom:{type:"boolean"},data_source:{type:"url"},
